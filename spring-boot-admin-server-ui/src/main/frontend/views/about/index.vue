  ...
  <div class="section">
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          To monitor applications, they must be registered at this server. This
          is either done by including the
          <a
        ...
        <p>
          ...
          <a href="https://gitter.im/codecentric/spring-boot-admin"> Gitter </a>
          channel.
        </p>
        <p>
        ...
        <div class="about-links">
          ...
          <a
            class="button is-stackoverflow is-outlined"
            href="https://stackoverflow.com/questions/tagged/spring-boot-admin"
          >
            <font-awesome-icon
              size="lg"
          ...
          <a
            class="button is-gitter is-outlined"
      ...
      <div class="content">
        ...
        <p>
          ...
          <a href="https://pivotal.io/"> Pivotal Software, Inc. </a> in the U.S.
          and other countries.
        </p>
      </div>
    </div>
