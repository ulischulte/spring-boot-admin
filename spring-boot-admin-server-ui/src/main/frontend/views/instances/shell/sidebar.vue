...
<template>
  <aside class="sidebar">
    ...
    >
      <div class="instance-summary__name" v-text="instance.registration.name" />
      <div class="instance-summary__id" v-text="instance.id" />
    </router-link>
    <ul>
      <li
        ...
        @mouseenter="
          hasMultipleViews(group) && !isActiveGroup(group) && showFlyout($event)
        "
        @mouseleave="
          hasMultipleViews(group) && !isActiveGroup(group) && hideFlyout($event)
        "
      >
        <router-link
          :to="{
          ...
          :class="{ 'is-active': isActiveGroup(group) }"
        />
        <ul v-if="hasMultipleViews(group)" class="sidebar-group-items">
          <li v-for="view in group.views" :key="view.name">
            <router-link
