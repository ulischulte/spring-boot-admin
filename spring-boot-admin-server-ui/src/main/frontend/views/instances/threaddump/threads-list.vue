            ...
            >
              ...
              <template v-if="getThreadDetails(thread) !== null">
                ...
                <tr>
                  <td
                    v-text="
                      $t('instances.threaddump.thread_details_blocked_count')
                    "
                  />
                ...
                <tr>
                  <td
                    v-text="
                      $t('instances.threaddump.thread_details_blocked_time')
                    "
                  />
                ...
                <tr>
                  <td
                    v-text="
                      $t('instances.threaddump.thread_details_waited_count')
                    "
                  />
                ...
                <tr>
                  <td
                    v-text="
                      $t('instances.threaddump.thread_details_waited_time')
                    "
                  />
                ...
                <tr>
                  <td
                    v-text="
                      $t('instances.threaddump.thread_details_lock_owner_id')
                    "
                  />
                ...
                <tr>
                  <td
                    v-text="
                      $t('instances.threaddump.thread_details_lock_owner_name')
                    "
                  />
...
export default {
  ...
  methods: {
    getThreadDetails(thread) {
      return thread.timeline.find(
        (entry) => entry.start === this.showDetails[thread.threadId]
      ).details;
    },
